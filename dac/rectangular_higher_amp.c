...
/* The following arrays have more or less the same structure: first member is the address of the registry, 
   ...
   The values themselves can be described with the following: 
			...
			- write_gen     - value which enables the configuration of a rectangular wave with the code step of 1 LSB and slew rate of 25.6 us,
...

{
        ...
        unsigned char write_gen[] = {GENERAL_CONFIG, 0xC0, 0x00};  
